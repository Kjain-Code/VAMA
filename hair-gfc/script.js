// sticky header shadow on scroll
  ...
  const stageToConcern = {
    thin: 'Thinning / low density',
    fall: 'Excessive hair fall',
    early: 'Early-stage baldness',
    boost: 'Post-transplant boost',
  ...
  leadForm.addEventListener('submit', (e) => {
    ...
    const msg = `Hi VAMA Clinic, I'd like a free GFC/PRP hair analysis.%0AName: ${encodeURIComponent(name)}%0APhone: ${phone}%0APreferred clinic: ${encodeURIComponent(city)}%0AConcern: ${encodeURIComponent(concern)}`;
